...
export default function Home(){
  return (
    <div className="mx-auto my-10 px-10 py-10 max-w-4xl bg-black/60 backdrop-blur-md rounded-3xl shadow-2xl relative text-white">
      ...
      <p className="text-white text-lg mb-4">Explore my <a href="#projects" className="text-white no-underline font-semibold hover:underline">projects</a> or <a href="#about" className="text-white no-underline font-semibold hover:underline">learn more about me</a>.</p>
    </div>
  );
}
